            ...
            <div className='d-flex justify-content-center align-items-center shadow'>
                <section className='text-center'>
                    ...
                    <div className='d-flex justify-content-center'>
                        <Button className='d-flex align-items-center' variant="dark" onClick={() => handleLoginGithub()}> <img className='githubImg me-2' src={githubIconWhite} alt="img" /> login with GitHub</Button>
                    </div>
                    <div className='d-flex justify-content-center'>
                        <Button className='d-flex align-items-center mt-2 rounded-0 shadow' variant="light" onClick={() => handleLoginGoogle()}> <img className='githubImg me-2' src={googleIcon} alt="img" /> login with Google</Button>
                    </div>
                </section>
            </div>
        </div>
